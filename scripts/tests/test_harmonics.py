"""File for testing harmonics() method of FeatureGenerator class."""
...
# test harmonics() method of FeatureGenerator class:
...
X = feature_generator.generate_features("harmonics", X_raw, feature_gen_params)
print(X.shape)
